...
class Base64Test {
    @Test fun c2b_00() { assertEquals(0x00.toByte(), Base64.c2b('A')) }
    @Test fun c2b_01() { assertEquals(0x01.toByte(), Base64.c2b('B')) }
    @Test fun c2b_02() { assertEquals(0x02.toByte(), Base64.c2b('C')) }
    @Test fun c2b_03() { assertEquals(0x03.toByte(), Base64.c2b('D')) }
    @Test fun c2b_04() { assertEquals(0x04.toByte(), Base64.c2b('E')) }
    @Test fun c2b_05() { assertEquals(0x05.toByte(), Base64.c2b('F')) }
    @Test fun c2b_06() { assertEquals(0x06.toByte(), Base64.c2b('G')) }
    @Test fun c2b_07() { assertEquals(0x07.toByte(), Base64.c2b('H')) }
    @Test fun c2b_08() { assertEquals(0x08.toByte(), Base64.c2b('I')) }
    @Test fun c2b_09() { assertEquals(0x09.toByte(), Base64.c2b('J')) }
    @Test fun c2b_0a() { assertEquals(0x0a.toByte(), Base64.c2b('K')) }
    @Test fun c2b_0b() { assertEquals(0x0b.toByte(), Base64.c2b('L')) }
    @Test fun c2b_0c() { assertEquals(0x0c.toByte(), Base64.c2b('M')) }
    @Test fun c2b_0d() { assertEquals(0x0d.toByte(), Base64.c2b('N')) }
    @Test fun c2b_0e() { assertEquals(0x0e.toByte(), Base64.c2b('O')) }
    @Test fun c2b_0f() { assertEquals(0x0f.toByte(), Base64.c2b('P')) }
    @Test fun c2b_10() { assertEquals(0x10.toByte(), Base64.c2b('Q')) }
    @Test fun c2b_11() { assertEquals(0x11.toByte(), Base64.c2b('R')) }
    @Test fun c2b_12() { assertEquals(0x12.toByte(), Base64.c2b('S')) }
    @Test fun c2b_13() { assertEquals(0x13.toByte(), Base64.c2b('T')) }
    @Test fun c2b_14() { assertEquals(0x14.toByte(), Base64.c2b('U')) }
    @Test fun c2b_15() { assertEquals(0x15.toByte(), Base64.c2b('V')) }
    @Test fun c2b_16() { assertEquals(0x16.toByte(), Base64.c2b('W')) }
    @Test fun c2b_17() { assertEquals(0x17.toByte(), Base64.c2b('X')) }
    @Test fun c2b_18() { assertEquals(0x18.toByte(), Base64.c2b('Y')) }
    @Test fun c2b_19() { assertEquals(0x19.toByte(), Base64.c2b('Z')) }
    @Test fun c2b_1a() { assertEquals(0x1a.toByte(), Base64.c2b('a')) }
    @Test fun c2b_1b() { assertEquals(0x1b.toByte(), Base64.c2b('b')) }
    @Test fun c2b_1c() { assertEquals(0x1c.toByte(), Base64.c2b('c')) }
    @Test fun c2b_1d() { assertEquals(0x1d.toByte(), Base64.c2b('d')) }
    @Test fun c2b_1e() { assertEquals(0x1e.toByte(), Base64.c2b('e')) }
    @Test fun c2b_1f() { assertEquals(0x1f.toByte(), Base64.c2b('f')) }
    @Test fun c2b_20() { assertEquals(0x20.toByte(), Base64.c2b('g')) }
    @Test fun c2b_21() { assertEquals(0x21.toByte(), Base64.c2b('h')) }
    @Test fun c2b_22() { assertEquals(0x22.toByte(), Base64.c2b('i')) }
    @Test fun c2b_23() { assertEquals(0x23.toByte(), Base64.c2b('j')) }
    @Test fun c2b_24() { assertEquals(0x24.toByte(), Base64.c2b('k')) }
    @Test fun c2b_25() { assertEquals(0x25.toByte(), Base64.c2b('l')) }
    @Test fun c2b_26() { assertEquals(0x26.toByte(), Base64.c2b('m')) }
    @Test fun c2b_27() { assertEquals(0x27.toByte(), Base64.c2b('n')) }
    @Test fun c2b_28() { assertEquals(0x28.toByte(), Base64.c2b('o')) }
    @Test fun c2b_29() { assertEquals(0x29.toByte(), Base64.c2b('p')) }
    @Test fun c2b_2a() { assertEquals(0x2a.toByte(), Base64.c2b('q')) }
    @Test fun c2b_2b() { assertEquals(0x2b.toByte(), Base64.c2b('r')) }
    @Test fun c2b_2c() { assertEquals(0x2c.toByte(), Base64.c2b('s')) }
    @Test fun c2b_2d() { assertEquals(0x2d.toByte(), Base64.c2b('t')) }
    @Test fun c2b_2e() { assertEquals(0x2e.toByte(), Base64.c2b('u')) }
    @Test fun c2b_2f() { assertEquals(0x2f.toByte(), Base64.c2b('v')) }
    @Test fun c2b_30() { assertEquals(0x30.toByte(), Base64.c2b('w')) }
    @Test fun c2b_31() { assertEquals(0x31.toByte(), Base64.c2b('x')) }
    @Test fun c2b_32() { assertEquals(0x32.toByte(), Base64.c2b('y')) }
    @Test fun c2b_33() { assertEquals(0x33.toByte(), Base64.c2b('z')) }
    @Test fun c2b_34() { assertEquals(0x34.toByte(), Base64.c2b('0')) }
    @Test fun c2b_35() { assertEquals(0x35.toByte(), Base64.c2b('1')) }
    @Test fun c2b_36() { assertEquals(0x36.toByte(), Base64.c2b('2')) }
    @Test fun c2b_37() { assertEquals(0x37.toByte(), Base64.c2b('3')) }
    @Test fun c2b_38() { assertEquals(0x38.toByte(), Base64.c2b('4')) }
    @Test fun c2b_39() { assertEquals(0x39.toByte(), Base64.c2b('5')) }
    @Test fun c2b_3a() { assertEquals(0x3a.toByte(), Base64.c2b('6')) }
    @Test fun c2b_3b() { assertEquals(0x3b.toByte(), Base64.c2b('7')) }
    @Test fun c2b_3c() { assertEquals(0x3c.toByte(), Base64.c2b('8')) }
    @Test fun c2b_3d() { assertEquals(0x3d.toByte(), Base64.c2b('9')) }
    @Test fun c2b_3e() { assertEquals(0x3e.toByte(), Base64.c2b('+')) }
    @Test fun c2b_3f() { assertEquals(0x3f.toByte(), Base64.c2b('/')) }
    ...
    @Test
    fun pack64_Zeros() {
        val packed = Base64.pack64(arrayOf(0, 0, 0, 0))
    ...
    fun pack64_single_01() {
        val packed = Base64.pack64(arrayOf(0x3f, 0, 0, 0))
        assertEquals(3, packed.size)
        assertEquals(0b1111_1100.toByte(), packed[0])
        assertEquals(0b0000_0000.toByte(), packed[1])
        assertEquals(0b0000_0000.toByte(), packed[2])
    }

    @Test
    fun pack64_single_02() {
        val packed = Base64.pack64(arrayOf(0, 0x3f, 0, 0))
        assertEquals(3, packed.size)
        assertEquals(0b0000_0011.toByte(), packed[0])
        assertEquals(0b1111_0000.toByte(), packed[1])
        assertEquals(0b0000_0000.toByte(), packed[2])
    }

    @Test
    fun pack64_single_03() {
        val packed = Base64.pack64(arrayOf(0, 0, 0x3f, 0))
        assertEquals(3, packed.size)
        assertEquals(0b0000_0000.toByte(), packed[0])
        assertEquals(0b0000_1111.toByte(), packed[1])
        assertEquals(0b1100_0000.toByte(), packed[2])
    }

    @Test
    fun pack64_single_04() {
        val packed = Base64.pack64(arrayOf(0, 0, 0, 0x3f))
        assertEquals(3, packed.size)
        assertEquals(0b0000_0000.toByte(), packed[0])
        assertEquals(0b0000_0000.toByte(), packed[1])
        assertEquals(0b0011_1111.toByte(), packed[2])
    }
    ...
    fun decode_Zeros() {
        ...
        assertEquals(0x00.toByte(), decoded[2])
        assertEquals(0x00.toByte(), decoded[3])
        assertEquals(0x00.toByte(), decoded[4])
        assertEquals(0x00.toByte(), decoded[5])
        assertEquals(0x00.toByte(), decoded[6])
        assertEquals(0x00.toByte(), decoded[7])
        assertEquals(0x00.toByte(), decoded[8])
    }
    @Test
    fun decode_01() {
